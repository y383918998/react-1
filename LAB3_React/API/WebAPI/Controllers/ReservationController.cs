...
namespace WebAPI.Controllers
{
    public class ReservationController : ApiController
    {
        ...
        public RetData Post([FromBody]RVModel rVModel)
        {
            ...
            {
                rVModel.EndTime=DateTime.Parse(rVModel.BeginTime).AddDays(1).ToString();
            }
        ...
        public RetData Get(int id)
        {
            ...
            on b.UId=c.Id
            left join t_user d
            on a.UID=d.Id where a.uid=@uid  and a.status=1 and a.Type=0";
            var data = Data.DataHelper.Query<RVModel>(sql, new { uid= id });
            retData.Code=200;
            retData.Status=true;
            retData.Data=data;
            return retData;
